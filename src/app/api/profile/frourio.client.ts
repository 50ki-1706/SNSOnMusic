...
import { z } from 'zod';
import { frourioSpec as frourioSpec_1vv65m8 } from './frourio'
...
export const $fc = (option?: FrourioClientOption) => ({
  ...
  $build(req?: { init?: RequestInit }): [
    ...
    return [{ lowLevel: false, baseURL: option?.baseURL, dir: '/api/profile' }, () => $fc(option).$get(req)];
  },
