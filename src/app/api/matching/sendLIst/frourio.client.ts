...
import { z } from 'zod';
import { frourioSpec as frourioSpec_1lso0e7 } from './frourio'
...
export const $fc = (option?: FrourioClientOption) => ({
  ...
  $build(req?: { init?: RequestInit }): [
    ...
    return [{ lowLevel: false, baseURL: option?.baseURL, dir: '/api/matching/sendLIst' }, () => $fc(option).$get(req)];
  },
