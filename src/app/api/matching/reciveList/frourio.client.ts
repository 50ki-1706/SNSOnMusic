...
import { z } from 'zod';
import { frourioSpec as frourioSpec_1wayw5l } from './frourio'
...
export const $fc = (option?: FrourioClientOption) => ({
  ...
  $build(req?: { init?: RequestInit }): [
    ...
    return [{ lowLevel: false, baseURL: option?.baseURL, dir: '/api/matching/reciveList' }, () => $fc(option).$get(req)];
  },
