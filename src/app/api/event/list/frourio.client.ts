...
import { z } from 'zod';
import { frourioSpec as frourioSpec_16i2dky } from './frourio'
...
export const $fc = (option?: FrourioClientOption) => ({
  ...
  $build(req: Parameters<ReturnType<typeof methods_16i2dky>['$get']>[0] | null): [
    ...
    return [{ lowLevel: false, baseURL: option?.baseURL, dir: '/api/event/list', ...rest }, () => $fc(option).$get(req)];
  },
