...
import { z } from 'zod';
import { frourioSpec as frourioSpec_zyt6bp } from './[id]/frourio';
import { frourioSpec as frourioSpec_1v06zis } from './[id]/cancel/frourio';
import { frourioSpec as frourioSpec_1b1jnsd } from './feedback/frourio';
import { frourioSpec as frourioSpec_1pizs8y } from './join/frourio';
import { frourioSpec as frourioSpec_16i2dky } from './list/frourio';
...
export const $fc = (option?: FrourioClientOption) => ({
  '[id]': {
    ...
    $build(req: Parameters<ReturnType<typeof methods_zyt6bp>['$get']>[0] | null): [
      ...
      return [{ lowLevel: false, baseURL: option?.baseURL, dir: '/api/event/[id]', ...rest }, () => $fc(option)['[id]'].$get(req)];
    },
  ...
  'list': {
    ...
    $build(req: Parameters<ReturnType<typeof methods_16i2dky>['$get']>[0] | null): [
      ...
      return [{ lowLevel: false, baseURL: option?.baseURL, dir: '/api/event/list', ...rest }, () => $fc(option)['list'].$get(req)];
    },
